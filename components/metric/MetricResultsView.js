...
import { cumulativeBroadHabitatChange } from '@abitat/bng/browser';
import {
  Box, Text, VStack, HStack, Heading, Badge, Tabs, SimpleGrid,
...
export default function MetricResultsView({ result, onReset, actions }) {
    ...
    <Box>
      ...
      <PrimaryCard mb={5}>
        <HStack justifyContent="space-between" flexWrap="wrap" gap={3}>
          ...
          <HStack gap={2}>
            {actions}
            {onReset && <Button onClick={onReset}>Upload Different File</Button>}
          </HStack>
        </HStack>
      </PrimaryCard>
