    ...
    <>
      <div className="container">
        <div className="main prose">
            ...
            <h3>Allocation</h3><>The planned habitat set aside by a BGS site to meet the BNG requirements of a specific development.</>
            ...
            <h3>Biodiversity Net Gain (BNG)</h3><> An approach that requires that most new developments leave the natural environment in a measurably better state than before. An increase of at least 10% in biodiversity through habitat creation and/or enhancement is required.</>
            ...
            <h3>Local Nature Recovery Strategy (LNRS) site</h3><> A location within an LNRS that holds significance for nature recovery. These sites can be either existing valuable areas for wildlife or opportunity areas, where habitat creation or restoration is planned to deliver the greatest environmental benefits, such as improving biodiversity, carbon sequestration or flood regulation.</>
