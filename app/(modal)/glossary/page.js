    ...
    <>
      <div className="container">
        <div className="main prose">
            ...
            <h3>Biodiversity Net Gain (BNG)</h3><p>An approach that requires that most new developments leave the natural environment in a measurably better state than before. An increase of at least 10% in biodiversity through habitat retention, creation and/or enhancement is required.</p>
            <h3>Condition</h3><p>The ecological health and functional status of a habitat, indicating its resilience and how well it supports its ecosystem. It's assessed using criteria for specific habitat types, often resulting in a rating (e.g. good, moderate or poor) based on factors like species presence, management and disturbance.</p>
            ...
            <h3>Lower Layer Super Output Area (LSOA)</h3><p>The smallest geographic unit used in England and Wales for statistical purposes, typically comprising 1,000 to 3,000 residents and 400 to 1,200 households.</p>
            ...
            <h3>Responsible Body</h3><p>An organisation designated by Defra to hold and administer conservation covenants for BNG projects, monitoring and enforcing habitat improvement plans to ensure long-term conservation.</p>
            <h3>Size</h3><p>Either area habitats, measured in hectares (ha), or linear habitats (hedgerows and watercourses), measured in kilometres (km).</p>
