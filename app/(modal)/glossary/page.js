    ...
    <>
      <div className="container">
        <div className="main prose">
            ...
            <h3>Local Nature Recovery Strategy (LNRS) site</h3><> An England-wide system of spatial strategies required by the Environment Act 2021 that identifies priorities and maps proposals for nature recovery at the local level. These strategies are designed to map existing important habitats, identify areas for new or improved habitats, set out priorities for action, and integrate with the planning system to support wider environmental benefits like flood management, carbon storage, and water quality.</>
