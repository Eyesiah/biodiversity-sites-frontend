    ...
    <>
      <div className="container">
        <div className="main prose">
            ...
            <h3>Biodiversity Net Gain (BNG)</h3><p>An approach that requires that most new developments leave the natural environment in a measurably better state than before. An increase of at least 10% in biodiversity through habitat retention, creation and/or enhancement is required. See <ExternalLink href="https://www.gov.uk/guidance/understanding-biodiversity-net-gain">Understanding biodiversity net gain guidance</ExternalLink>.</p>
