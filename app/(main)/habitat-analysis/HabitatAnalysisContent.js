  ...
  return (
    <TableContainer>
      <DataTable.Root>
        <DataTable.Header>
          <DataTable.Row>
            <DataTable.ColumnHeader colSpan="2" color="black" backgroundColor='bg' borderRight="4px solid tableSection.border">Intervention Groups</DataTable.ColumnHeader>
            <DataTable.ColumnHeader colSpan="3" color="black" backgroundColor='tableSection.baselineBg' borderRight="4px solid tableSection.border">Baseline</DataTable.ColumnHeader>
            <DataTable.ColumnHeader colSpan="4" color="black" backgroundColor='tableSection.improvementsBg' borderRight="4px solid tableSection.border">Improvements</DataTable.ColumnHeader>
            <DataTable.ColumnHeader colSpan="4" color="black" backgroundColor='tableSection.allocationsBg' borderRight="4px solid tableSection.border">Allocations</DataTable.ColumnHeader>
          </DataTable.Row>
          <DataTable.Row>
            ...
            <DataTable.ColumnHeader onClick={() => requestSort('distinctiveness')} {...getSortProps('distinctiveness', sortConfig)} textAlign="center" borderRight="4px solid tableSection.border"><GlossaryTooltip term='Distinctiveness'>Distinctiveness</GlossaryTooltip></DataTable.ColumnHeader>
            ...
            <DataTable.ColumnHeader onClick={() => requestSort('baselineShare')} {...getSortProps('baselineShare', sortConfig)} borderRight="4px solid tableSection.border"><Tooltip text="The percentage share of the total baseline habitats.">% Baseline</Tooltip></DataTable.ColumnHeader>
            ...
            <DataTable.ColumnHeader onClick={() => requestSort('improvementShare')} {...getSortProps('improvementShare', sortConfig)} borderRight="4px solid tableSection.border"><Tooltip text="The percentage share of the total improved habitats.">% Improved</Tooltip></DataTable.ColumnHeader>
        ...
        <DataTable.Body>
          <DataTable.Row fontWeight='bold' backgroundColor='tableTotalsBg'>
            <DataTable.Cell colSpan="2" textAlign="right" borderRight="4px solid tableSection.border">Totals:</DataTable.Cell>
            ...
            <DataTable.Cell borderRight="4px solid tableSection.border"></DataTable.Cell>
          ...
          {processedData.map(row => (
            <DataTable.Row key={row.habitat}>
              ...
              <DataTable.Cell textAlign='center' borderRight="4px solid tableSection.border">{row.distinctiveness}</DataTable.Cell>
              ...
              <DataTable.NumericCell borderRight="4px solid tableSection.border">{formatNumber(row.baselineShare, 2)}%</DataTable.NumericCell>
              ...
              <DataTable.NumericCell borderRight="4px solid tableSection.border">{formatNumber(row.improvementShare, 2)}%</DataTable.NumericCell>
