...
/**
 * Convenience hook for components that need re-renders when cache updates (like PolygonMap)
 * Uses the same pattern as usePolygonCacheRef for consistency.
 */
export const usePolygonCacheState = () => {
  return usePolygonCacheRef();
};
