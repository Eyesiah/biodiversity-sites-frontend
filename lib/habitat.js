...
// Store distinctiveness scores for client-side use
const distinctivenessScores = new Map();
...
// Debug function to expose habitat map to browser console
if (typeof window !== 'undefined') {
  window.habitatDebug = {
    habitats: Array.from(habitatMap.keys()),
    getHabitat: (habitat) => habitatMap.get(habitat.toLowerCase()),
    hasHabitat: (habitat) => habitatMap.has(habitat.toLowerCase())
  };
}
