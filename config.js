export const API_URL = process.env.NEXT_PUBLIC_API_URL || 'http://BGS-register-API.eu-central-1.elasticbeanstalk.com';

export const ARCGIS_LSOA_URL = 'https://services1.arcgis.com/ESMARspQHYMw9BZ9/arcgis/rest/services/Lower_layer_Super_Output_Areas_Dec_2011_Boundaries_Full_Clipped_BFC_EW_V3_2022/FeatureServer/0/query';
